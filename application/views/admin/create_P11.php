                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="<?php echo base_url('P11_admin/proses');?>" method="post" enctype="multipart/form-data">
                                ...
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                    <form role="form" action="<?php echo base_url('P11_admin/proses_pertanyaan');?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                    ...
                                    <form role="form" action="<?php echo base_url('P11_admin/save');?>" method="post" enctype="multipart/form-data">                                     
                                        <fieldset hidden>
                                        <div class="form-group">
                                            <label>Kode</label>
                                            <?php foreach ($permasalahan_select_id as $key) { ?>
