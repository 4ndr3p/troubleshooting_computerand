...
<head>
    ...
    <title>Admin | Troubleshooting Komputer</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>admin">Admin | Troubleshooting Komputer</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="<?php echo base_url($key->kode);?>_admin"><?php echo $key->permasalahan;?></a>
                                </li>
                                <?php } ?>
                                    <!-- /.nav-third-level -->
                                </li>
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>pakar_tambah"><i class="fa fa-user-md fa-fw"></i> Pakar</a>
                        </li>                        
<!--                         <li>
