...
<!--                 <div class="col-lg-3 col-md-6">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-info">
                        ...
                        <a href="<?php echo base_url(); ?>P1_pakar">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-success">
                        ...
                        <a href="<?php echo base_url(); ?>P2_pakar">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-warning">
                        ...
                        <a href="<?php echo base_url(); ?>P3_pakar">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-danger">
                        ...
                        <a href="<?php echo base_url(); ?>P4_pakar">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-info">
                        ...
                        <a href="<?php echo base_url(); ?>P5_pakar">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-success">
                        ...
                        <a href="<?php echo base_url(); ?>P6_pakar">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-warning">
                        ...
                        <a href="<?php echo base_url(); ?>P7_pakar">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-danger">
                        ...
                        <a href="<?php echo base_url(); ?>P8_pakar">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-info">
                        ...
                        <a href="<?php echo base_url(); ?>P9_pakar">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-success">
                        ...
                        <a href="<?php echo base_url(); ?>P10_pakar">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-warning">
                        ...
                        <a href="<?php echo base_url(); ?>P11_pakar">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-danger">
                        ...
                        <a href="<?php echo base_url(); ?>P12_pakar">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-info">
                        ...
                        <a href="<?php echo base_url(); ?>P13_pakar">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-success">
                        ...
                        <a href="<?php echo base_url(); ?>P14_pakar">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-warning">
                        ...
                        <a href="<?php echo base_url(); ?>P15_pakar">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-danger">
                        ...
                        <a href="<?php echo base_url(); ?>P16_pakar">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
