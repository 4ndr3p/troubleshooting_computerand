                            ...
                            <div class="row">   
                                <div class="col-lg-12">
                                    <form role="form" action="<?php echo base_url('aplikasi/proses_pertanyaan_awal');?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <fieldset disabled>
                                        <div class="form-group">
                                            <label for="id_awal">Pertanyaan Awal adalah</label>
                                ...
                                <!-- /.col-lg-12 (nested) -->
                             <div class="col-lg-6">
                                    <form role="form" action="<?php echo base_url('aplikasi/proses_pertanyaan_1');?>" method="post" enctype="multipart/form-data">
                                        <fieldset hidden>
                                        <div class="form-group">
                                            <input class="form-control" placeholder="Table" name="table" type="text" value="<?php echo $table;?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="ID_masalah" name="id_masalah" type="text" value="<?php echo $pertanyaan;?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="id_konten">Dengan tipe</label>
                                            <?php foreach ($tipe as $key) { ?>
                                            <input class="form-control" placeholder="Tipe" name="tipe" type="text" value="<?php echo $key->tipe;?>" readonly>
                                            <?php } ?>
                                        </div>
                                        </fieldset>
                                        <fieldset disabled>
                                        <div class="form-group">
                                            <label for="id_awal">Kemudian jawablah pertanyaan di bawah ini</label>
                                            <select id="id_awal" name="id_awal" class="form-control">
                                                <?php foreach ($id_tanya as $key) { ?>
                                        ...
                                        <button type="submit" name="ya" class="btn btn-warning" value="1"><b>YES / YA</b></button>
                                        <button type="submit" name="tidak" class="btn btn-danger" value="0"><b>NO / TIDAK</b></button>
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><b>Detail Pertanyaan</b></button>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="?" method="post">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="id_konten">dan detail pertanyaan</label>
                                                                    <textarea class="form-control" placeholder="Detail" name="detail" type="text" rows="5"><?php echo $key->detail;?></textarea>    
                                                                </div>
                                                                <?php } ?>
                                                            </form>
                                                        </div>    
                                ...
                                <!-- /.col-lg-6 (nested) -->
                             <div class="col-lg-6">
                                    <form role="form" action="<?php echo base_url('aplikasi/proses_jawaban_1');?>" method="post" enctype="multipart/form-data">
                                        <fieldset hidden>
                                        <div class="form-group">
                                            <input class="form-control" placeholder="Table" name="table" type="text" value="<?php echo $table;?>" readonly>
                                        </div>
                                        ...
                                        <fieldset disabled>
                                        <div class="form-group">
                                            <label for="id_awal">Jika sudah mendapatkan Jawaban dari Permasalahan Anda yaitu</label>
                                            <select id="id_awal" name="id_awal" class="form-control">
                                                <?php foreach ($id_jawab as $key) { ?>
                                                <option value="<?php echo $key->kode;?>"><?php echo $key->konten;?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        <button type="submit" class="btn btn-primary btn-lg btn-block"><b>LIHAT SOLUSI</b></button>
                                        </div>
                                        </fieldset>
                                    </form>
                                </div>
