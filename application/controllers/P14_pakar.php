...
class P14_pakar extends CI_Controller {
	...
	public function index()
	{
		if ($this->session->userdata('isLogin')==TRUE) {
	        $config['base_url'] = site_url('P14_pakar/index');
			...
			$this->template->load('pakar/index','pakar/P14_pakar',$data);
	...
	public function create_P14(){
		if ($this->session->userdata('isLogin')==TRUE) {
			...
			$data['menu_permasalahan'] = $this->m_data->getSemua('permasalahan');
			$this->template->load('pakar/index','pakar/create_P14',$data);
			//$this->template->load('pakar/index','pakar/footer');
		}else{
			redirect('login');
		}
	...
	public function save(){
		...
		if($this->form_validation->run()){
			...
			return redirect('pakar/index','pakar/create_P14');
		} else {
	...
	public function edit($key_id){
		if ($this->session->userdata('isLogin')==TRUE) {
			...
			$data['menu_permasalahan'] = $this->m_data->getSemua('permasalahan');
			$this->template->load('pakar/index','pakar/update_P14',$data);
			//$this->template->load('pakar/index','pakar/footer');
		}else{
			redirect('login');
		}
	...
	public function save_edit(){
		...
		if($this->form_validation->run()){
			...
			return redirect('pakar/index','pakar/update_P14');
		} else {
			$data['user'] =$this->m_data->getSemua('user');
			$this->template->load('pakar/index','pakar/update_P14',$data);
		}
